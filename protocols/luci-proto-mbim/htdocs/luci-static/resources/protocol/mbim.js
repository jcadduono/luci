...
network.registerErrorCode('NO_DEVICE',       _('Control device does not exist'));
network.registerErrorCode('NO_IFNAME',       _('Failed to find matching interface'));
network.registerErrorCode('NO_APN',          _('No APN specified'));
network.registerErrorCode('PIN_FAILED',      _('Unable to verify PIN'));
network.registerErrorCode('NO_SUBSCRIBER',   _('Subscriber init failed'));
network.registerErrorCode('NO_REGISTRATION', _('Subscriber registration failed'));
network.registerErrorCode('ATTACH_FAILED',   _('Failed to attach to network'));
...
return network.registerProtocol('mbim', {
	...
	renderFormOptions: function(s) {
		...
		o = s.taboption('general', form.Flag, 'ignore_pinfail', _('Ignore PIN failure'), _('If checked, continue trying to connect after PIN rejection'));
